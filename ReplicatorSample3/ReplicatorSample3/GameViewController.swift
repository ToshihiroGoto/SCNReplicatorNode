...
//  ReplicatorSample3
//
//  Created by Toshihiro Goto on 2018/04/11.
...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let deformedShpere:SCNGeometry = sphereGeometry.copy() as! SCNGeometry // Parameters will not be reflected unless geometry is copied
        ...
        // scale down the node in replicator node
